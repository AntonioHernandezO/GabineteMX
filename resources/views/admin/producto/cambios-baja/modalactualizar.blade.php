...
<div class="modal fullscreen" id="#actualizarproducto{{ $resultados->id_produc }}">
            ...
            <div class="agregarProductoCss">
              ...
              <div class="proveCss">
                <select id="id_provee" class="form-control" name="id_provee" disabled>
                  <option value="{{ $resultados->id_provee }}" selected="true" disabled="disabled">
                    {{ $resultados->nom }}</option>
              ...
              <div class="famProCss">
                ...
                <select id="id_familia" class="form-control" name="id_familia" disabled>
                  <option value="{{ $resultados->id_familia }}" selected="true" disabled="disabled">
                    {{ $resultados->nom_fami }}</option>
              ...
              <div class="subFamCss">
                ...
                <select id="clav_clas" class="form-control" name="clav_clas" disabled>
                  <option value="{{ $resultados->clav_clas }}" selected="true" disabled="disabled">
                    {{ $resultados->name }}</option>
              ...
              <div class="bttnCss">
                <center>
                  ...
                  <button type="submit" class="waves-effect waves-green btn green lighten-1">¡ACTUALIZAR!</button>
